...
<NativeShare title={frontmatter.title} description={frontmatter.description} />
...
Leave the text prop blank to use the current page URL by default, or pass in any custom text you'd like to be copied.
You can also set the button label and success label that appears after clicking.
Leave them blank to use as an icon only.
